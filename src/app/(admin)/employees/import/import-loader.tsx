...
/** Package S: the employee import on the party import kit, over `/party-imports/employees`. */
export function ImportLoader({ importId }: { importId: string | null }) {
    return <PartyImportLoader config={PARTY_IMPORT_CONFIGS["employees"]} importId={importId} />;
}
